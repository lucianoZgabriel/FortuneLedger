 ...
 * @notice This contract is a simple raffle contract that allows users to enter a raffle
 * @dev Implementing Chainlink VRF v2.5 to randomize the winner
 */
contract Raffle is VRFConsumerBaseV2Plus {
     ...
     * 1. The interval has passed between lottery runs.
     * 2. The lottery is open.
     * 3. There are players in the lottery.
